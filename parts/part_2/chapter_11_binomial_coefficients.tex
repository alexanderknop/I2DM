...
\begin{marginfigure}
  {\scriptsize Permutations and Binomial Coefficients:\\\noindent
  Introduction to Combinatorics \#4}
  \vskip 0.25cm
  \noindent
  \qrset{link, height=3cm}
  \qrcode{https://youtu.be/HLClazoqqzg}
  \vskip 0.25cm
  \noindent
  \url{youtu.be/HLClazoqqzg}
\end{marginfigure}
...
\begin{theorem}
\label{theorem:binomial-coefficients-equalitites}
...
\begin{exercise}
  ...
  Theorem~\ref{theorem:binomial-coefficients-equalitites}.
\end{exercise}
