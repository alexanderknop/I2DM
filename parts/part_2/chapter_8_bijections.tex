...
\begin{proof}
  ...
  We prove using induction by $n$ that if there is a bijection $h'$
  from $[n]$ to $[m]$ than $n = m$. The base case is for $n = 1$; if $m \ge 2$,
  ...
  \begin{itemize}
    \item Let $i_1 \neq i_2 \in [n]$. If $h'(i_1), h'(i_1) < h'(n + 1)$ or
      ...
      $h''(i_1) = h'(i_1) \le h'(n + 1) \le h'(i_2) - 1 = h''(i_2)$.
  \end{itemize}
\end{proof}
