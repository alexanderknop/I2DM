...
Note that P- and N-positions are definited recursively so in some games not all
the positions are either P- or N-positions. However, \Cref{theorem:grundy-to-np}
