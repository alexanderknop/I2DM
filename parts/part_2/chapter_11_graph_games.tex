...
Assume that a Sprague--Grundy funciton $g$ for \Cref{game:take-away-21-3-2-1}
...
To prove \Cref{theorem:ending-condiction-sg-function} we need an alternative
...
\begin{proof}[Proof of \Cref{theorem:ending-condiction-sg-function}]
  Note that \Cref{lemma:konig} claims that $V = \bigcup_{n \in \N_0} V_n$, where
