...
\begin{chapterendexercises}
  \exercise Find the generating functions of each of the following sequences
    ...
    \begin{enumerate}[nolistsep]
      ...
      \end{multicols}
    \end{enumerate}
  \exercise Let $F(x)$ be a generating function for the sequence
  ...
  \exercise Let $a_n$ be the number of ways to pay $n$ dollars using ten-dollar
