...
\begin{marginfigure}
  {\scriptsize Propositional Formulas:\\\noindent
  Introduction to Mathematical Logic \#1}
  \vskip 0.25cm
  \noindent
  \qrset{link, height=3cm}
  \qrcode{https://youtu.be/X0797bVFf3Y}
  \vskip 0.25cm
  \noindent
  \url{youtu.be/X0797bVFf3Y}
\end{marginfigure}
...
\begin{marginfigure}
  {\scriptsize Proofs Using Truth Tables:\\\noindent
  Introduction to Mathematical Logic \#2}
  \vskip 0.25cm
  \noindent
  \qrset{link, height=3cm}
  \qrcode{https://youtu.be/DOAxnmScpPc}
  \vskip 0.25cm
  \noindent
  \url{youtu.be/DOAxnmScpPc}
\end{marginfigure}
...
\begin{marginfigure}
  {\scriptsize Natural Deduction:\\\noindent
  Introduction to Mathematical Logic \#3}
  \vskip 0.25cm
  \noindent
  \qrset{link, height=3cm}
  \qrcode{https://youtu.be/PfVafyptFtM}
  \vskip 0.25cm
  \noindent
  \url{youtu.be/PfVafyptFtM}
\end{marginfigure}
