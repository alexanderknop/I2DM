...
For example, $((x_1 \lor x_2) \land x_3)$ is a propositional formula on the
variables from $\set{x_1, x_2, x_3}$ (we also say that it is a formula on
$x_1$, $x_2$, $x_3$).
...
\begin{definition}
  ...
  $\rho$ such that $\rho(x_i) = v_i$ for each $i \in [n]$.
\end{definition}
