...
\label{corollary:multiplicative-principle-probability}
   ...
   discrete peobability spaces such that $\Pr(\omega_1, \omega_2) = 
...
flip is $H$ are independant. Indeed, let $\Omega = \set{H, T}^5$; $\Pr$
be the uniform distribution on $\Omega$; and 
$E_1 = \set[t_1 = H]{t \in \set{H, T}^5}$ and
$E_2 = \set[t_2 = H]{t \in \set{H, T}^5}$. By
\Cref{corollary:multiplicative-principle-probability},
