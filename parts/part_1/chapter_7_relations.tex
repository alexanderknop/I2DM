...
% TODO the section about the isomorphisms
...
\begin{exercise}
  Prove the rest of \Cref{theorem:lattice-properties}.
\end{exercise}
...
From \Cref{exercise:set-boolean-algebra} we know that $\subseteq$ forms a Boolean
