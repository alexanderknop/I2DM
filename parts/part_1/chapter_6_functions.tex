\chapter{Functions}
\begin{marginfigure}
  {\scriptsize Functions and Quantifiers:\\\noindent
...
\nomenclature[P]{$\forall \alpha \in A~P(a)$}{denotes the statement saying that
$P$ is true for all elements of $A$}

\paragraph{The Existential Quantifier.}
The second quantifier means ``there is'' and denoted by the symbol $\exists$\footnote{%
...
equation $x^2 - 1 = 0$.
\nomenclature[P]{$\exists \alpha \in A~P(a)$}{denotes the statement saying that $P$ is
true for some element of $A$}
...
plane.
\nomenclature[SO]{$A \times B$}{denotes the set of all ordered pairs of elements of
$A$ and $B$}
